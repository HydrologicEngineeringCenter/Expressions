...
public class LessThanNode<R extends Number,L extends Number> extends BinaryExpressionNode<Boolean,R, L> {
    ...
    /**
     * A boolean {@link BinaryExpressionNode} that evaluates two children (numerical {@link ExpressionNode}s), returning whether the left child's value is less than the right child's value
